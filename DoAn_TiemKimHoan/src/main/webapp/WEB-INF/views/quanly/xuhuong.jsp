         ...
         <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-clock-o fa-3x"></i> Quản Lý Đơn Hàng<span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="hoadon.htm">ĐƠN NHẬP/XUẤT HÀNG</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="khachhang.htm"><i class="fa fa-sitemap fa-3x"></i> Quản lý Khách Hàng</a>
                        <!-- <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="nhanvien.htm"><i class="fa fa-sitemap fa-3x"></i> Quản lý Nhân viên</a>
