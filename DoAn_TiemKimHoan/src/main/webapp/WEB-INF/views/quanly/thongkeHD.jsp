				...
				<ul class="nav" id="main-menu">
					...
					<li><a href="#"><i class="fa fa-clock-o fa-3x"></i> Quản
						...
						<ul class="nav nav-second-level">
							<li><a href="hoadon.htm">ĐƠN NHẬP/XUẤT HÀNG</a></li>
					...
					<li><a href="khachhang.htm"><i class="fa fa-sitemap fa-3x"></i>
							Quản lý Khách Hàng</a> <!-- <ul class="nav nav-second-level">
                                    <li>
					...
					<li><a href="nhanvien.htm"><i class="fa fa-sitemap fa-3x"></i>
				...
				<div class="row">
					...
					<div class="col-md-9 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-heading">THỐNG KÊ HÓA ĐƠN Example</div>
