...
<div class="container wrapper">
            ...
            <div class="row cart-body">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
                   ...
                   <form:form action="checkout" method="POST" modelAttribute="DonDatHang" class="form-horizontal">  
                            <div class="form-group">
                            ...
                            <div class="form-group test">
                                <div class="col-xs-12">
                                <c:if test="${not empty DonDatHang.diaChiNhanHang }">
                                <button type="submit" class="btn btn-primary btn-submit-fix" onclick="alert('Thanh toán thành công!')">Thanh toán</button> 
                                </c:if>
                                <c:if test="${empty DonDatHang.diaChiNhanHang }">
                                <button type="submit" class="btn btn-primary btn-submit-fix" onclick="alert('Vui lòng nhập địa chỉ để hoàn tất quá trình thanh toán!')">Thanh toán</button> 
                                </c:if>
